...
// Cloudinary setup
cloudinary.config({
    cloud_name: 'facebook-clone',
    api_key: '249252992244463',
    api_secret:'ERfL_nDdzOdRIt6z1Gt3WSjnGKM' 
});
...
router.post("/user/register", upload.single("image"), (req, res) => {
    if (
        ...
        if (req.file) {
            ...
            newUser.profile = 'https://netstorage-legit.akamaized.net/images/vllkyt1uc3jd8n61v8.jpg';
            return createUser(newUser, req.body.password, req, res);
        }
    }
});
